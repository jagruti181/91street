...
class Json extends CI_Controller 
{
    ...
    {
    	$user=$this->input->get_post('user');
	$data["message"]=$this->user_model->clearshoppingbag($user);
	$this->load->view("json",$data);
    }
    ...
    public function searchbymall()
   {
    	$city=$this->input->get_post('city');
    	$search=$this->input->get_post('search');
        $data['message']=$this->mall_model->searchbymall($city,$search);
		$this->load->view('json',$data);
    ...
    public function getallbrandssearch()
    {
        $search=$this->input->get_post('search');
        $data['message']=$this->brand_model->getallbrandssearch($search);
		$this->load->view('json',$data);
    }
...
//        echo "insert in controller";
    ...
    public function searchstorepage()
    {
    	$name=$this->input->get_post('name');
    	$data['message']=$this->store_model->searchstorepage($name);
    	$this->load->view('json',$data);
